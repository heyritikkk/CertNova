...
* **Preparation:** Stockpiling hazmat suits, training doctors, and building negative-pressure quarantine rooms in advance.
  > *Real life example:* Think of a hospital Emergency Room responding to an infectious disease outbreak: Stockpiling hazmat suits, training doctors, and building negative-pressure quarantine rooms in advance.
* **Detection & Analysis:** Running blood tests on a coughing patient to identify the exact strain of virus and mapping out everyone they interacted with.
  > *Real life example:* Running blood tests on a coughing patient to identify the exact strain of virus and mapping out everyone they interacted with.
* **Containment:** Locking the patient inside an isolated quarantine room immediately so they don't infect the general hospital waiting room.
  > *Real life example:* Locking the patient inside an isolated quarantine room immediately so they don't infect the general hospital waiting room.
* **Eradication:** Administering targeted antiviral medications to destroy the pathogen inside the host.
  > *Real life example:* Administering targeted antiviral medications to destroy the pathogen inside the host.
* **Recovery:** Slowly discharging the healthy patient, cleaning the room, and letting them return to work.
  > *Real life example:* Slowly discharging the healthy patient, cleaning the room, and letting them return to work.
* **Post-Incident Activity:** Reviewing how the virus slipped past border entry gates to update future screening processes.
  > *Real life example:* Reviewing how the virus slipped past border entry gates to update future screening processes.
...
* **The Incident (Active Ransomware Outbreak):** At 3:00 AM, an enterprise network experiences an active ransomware outbreak. An infected workstation begins rapidly encrypting files across shared corporate network network storage drives via SMB protocols.
  > *Real life example:* At 3:00 AM, an enterprise network experiences an active ransomware outbreak. An infected workstation begins rapidly encrypting files across shared corporate network network storage drives via SMB protocols.
